...
function apfh() {
    ...
    <div class="rsdiv">
            ...
            <div class="innerdiv">
                ...
                <h4 class="fntclr">${data.data.confirmed}</h4>
            </div>
            ...
            <div class="innerdiv">
                ...
                <h4 class="fntclr">${data.data.recovered}</h4>
            </div>
            ...
            <div class="innerdiv">
                ...
                <h4 class="fntclr">${data.data.deaths}</h4>
            </div>
...
function cntryfetch() {
    ...
    var a = "https://covid-19-tracking.p.rapidapi.com/v1/";
    ...
    fetch(a, {
        ...
        .then(data => {
             console.log(data);
            let output = `<h1 class="reshead">${data.Country_text}'s Stats</h1>
    <div class="rsdiv">
            <img src="images/confirmed.png" class="cnfrm">
            <div class="innerdiv">
                <h3 class="fntclr">Confirmed</h3>
                <h4 class="fntclr">${data["Active Cases_text"]}</h4>
            </div>
            ...
            <div class="innerdiv">
                <h3 class="fntclr">Recovered</h3>
                <h4 class="fntclr">${data["Total Recovered_text"]}</h4>
            </div>
            ...
            <div class="innerdiv">
                <h3 class="fntclr">Death</h3>
                <h4 class="fntclr">${data["Total Deaths_text"]}</h4>
            </div>
